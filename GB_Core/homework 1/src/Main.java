 ...
 * @project  : HomeWork 1
 * @date     : 28.11.2021
 * @comments : программа отрабатывает дажды. Сперва со случайными
 * паарметрами, потом с «заказными». оба раза выводится информация о составе
 * и результатах до и после прохождения.
 *
 */
