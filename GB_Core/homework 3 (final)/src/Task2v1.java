/**
 * Задание 2 - Решение задачи о коробках «в лоб»
 *
...
public class Task2v1 {
    ...
    public static void main(String[] args) {
        ...
        // Они ссыпаются в одну коробку, а этого быть не должно!
        // обход этого казуса я реализую во втором варианте этого класса (Task2v2.java)
        // этот случай показателен тем что позволяет сложить несколько объектов разного типа в
        // один параметризованный контейнер
...
Коробка {[]}
Коробка {[Партия яблок {3 штук, массой 3.0f}, Партия яблок {10 штук, массой 10.0f}, Партия яблок {6 штук, массой 6.0f}, Партия яблок {3 штук, массой 3.0f}, Партия яблок {8 штук, массой 8.0f}]}
Коробка {[Партия яблок {3 штук, массой 3.0f}, Партия яблок {10 штук, массой 10.0f}, Партия яблок {6 штук, массой 6.0f}, Партия яблок {3 штук, массой 3.0f}, Партия яблок {8 штук, массой 8.0f}, Партия апельсинов {10 штук, массой 15.0f}, Партия апельсинов {6 штук, массой 9.0f}, Партия апельсинов {11 штук, массой 16.5f}]}
Коробка {[]}
